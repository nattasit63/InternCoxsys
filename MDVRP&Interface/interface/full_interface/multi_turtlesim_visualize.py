    ...
    while RUN:
        ...
        if state ==1:
            ...
            if result[-1]!=0.0 :
                ...
                # print(f'goal = {goal_x1},{goal_y1}')
                # print(f'cur = {x2},{y2}')
                # print(f' eul {arrive_id}: {eul}')
...
def run(fleet,customer_pos,map_loc):
    ...
    # PATH = [[[60, 449], [160, 522], [242, 415], [160, 522], [378, 508], [452, 587], [656, 592], [601, 519], [713, 490], [656, 592], [452, 587], [378, 508], [160, 522], [60, 449]], 
