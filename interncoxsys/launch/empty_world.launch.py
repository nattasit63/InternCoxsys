...
def generate_launch_description():
    ...
    robot_model = os.environ["GAZEBO_MODEL_PATH"] 
    # world_file_name = 'empty_worlds/' + robot_model + '.model'
    # world = os.path.join(get_package_share_directory('turtlebot3_gazebo'),
    #                      'worlds', world_file_name)
    world_file_name = 'nothing.world'
    world = os.path.join(pkg_dir, 'world', world_file_name)
    
    launch_file_dir = os.path.join(get_package_share_directory(pkg_dir), 'launch')
